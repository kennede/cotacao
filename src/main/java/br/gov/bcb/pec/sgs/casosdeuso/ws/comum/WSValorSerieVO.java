...
public class WSValorSerieVO  implements java.io.Serializable {
	...
	public String toString() {
		return "WSValorSerieVO [ano=" + ano + ", anoFim=" + anoFim + ", bloqueado=" + bloqueado + ", bloqueioLiberado="
				+ bloqueioLiberado + ", dia=" + dia + ", diaFim=" + diaFim + ", mes=" + mes + ", mesFim=" + mesFim
				+ ", oid=" + oid + ", oidSerie=" + oidSerie + ", svalor=" + svalor + ", valor=" + valor + "]";
	}
