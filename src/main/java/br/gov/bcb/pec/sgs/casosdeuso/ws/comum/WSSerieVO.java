...
public class WSSerieVO  implements java.io.Serializable {
	...
	public String toString() {
		return "WSSerieVO [anoFim=" + anoFim + ", anoInicio=" + anoInicio + ", aviso=" + aviso + ", diaFim=" + diaFim
				+ ", diaInicio=" + diaInicio + ", especial=" + especial + ", fonte=" + fonte + ", fullName=" + fullName
				+ ", gestorProprietario=" + gestorProprietario + ", mesFim=" + mesFim + ", mesInicio=" + mesInicio
				+ ", nomeAbreviado=" + nomeAbreviado + ", nomeCompleto=" + nomeCompleto + ", oid=" + oid
				+ ", periodicidade=" + periodicidade + ", periodicidadeSigla=" + periodicidadeSigla
				+ ", possuiBloqueios=" + possuiBloqueios + ", publica=" + publica + ", shortName=" + shortName
				+ ", unidadePadrao=" + unidadePadrao + ", unidadePadraoIngles="
				+ unidadePadraoIngles + ", valorDiaNaoUtil=" + valorDiaNaoUtil + ", valores=" + Arrays.toString(valores)
				+ "]";
	}
