...
public class FachadaWSSGSServiceLocator extends org.apache.axis.client.Service implements br.gov.bcb.www3.wssgs.services.FachadaWSSGS.FachadaWSSGSService {
    ...
    public FachadaWSSGSServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public br.gov.bcb.www3.wssgs.services.FachadaWSSGS.FachadaWSSGS getFachadaWSSGS() throws javax.xml.rpc.ServiceException {
    ...
    public br.gov.bcb.www3.wssgs.services.FachadaWSSGS.FachadaWSSGS getFachadaWSSGS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.gov.bcb.www3.wssgs.services.FachadaWSSGS.FachadaWSSGSSoapBindingStub _stub = new br.gov.bcb.www3.wssgs.services.FachadaWSSGS.FachadaWSSGSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.gov.bcb.www3.wssgs.services.FachadaWSSGS.FachadaWSSGS.class.isAssignableFrom(serviceEndpointInterface)) {
                br.gov.bcb.www3.wssgs.services.FachadaWSSGS.FachadaWSSGSSoapBindingStub _stub = new br.gov.bcb.www3.wssgs.services.FachadaWSSGS.FachadaWSSGSSoapBindingStub(new java.net.URL(FachadaWSSGS_address), this);
                _stub.setPortName(getFachadaWSSGSWSDDServiceName());
                return _stub;
            }
        }
